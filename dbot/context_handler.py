#------------------------------------------------------------------------------
# Description: This file contains the functions for saving and loading the
# context for a user. The context is a list of messages that have been sent to 
# the user. The context is saved to a file for each user.
#------------------------------------------------------------------------------
